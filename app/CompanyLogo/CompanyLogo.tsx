  ...
  return (
    <div className="w-full max-w-[1920px] py-8 sm:py-16 px-4 sm:px-8 md:px-16 lg:px-[300px]">
      <div className="flex flex-wrap justify-center sm:justify-between items-center gap-8 sm:gap-4">
        ...
        <img src="/logo3.png" alt="Company 3" className="h-8 sm:h-12" />
        <img src="/logo4.png" alt="Company 4" className="h-8 sm:h-12" />
        <img src="/logo5.png" alt="Company 5" className="h-8 sm:h-12" />
        <img src="/logo6.png" alt="Company 6" className="h-8 sm:h-12" />
        <img src="/logo7.png" alt="Company 7" className="h-8 sm:h-12" />
      </div>
    </div>
  );
}
