...
const ContactInfo = ({ icon, title, details }: ContactInfoProps) => (
  <div className="flex gap-4 items-start">
    <div className="text-[#029FAE] mt-1">
      {icon}
    </div>
    <div>
      <h2 className={`${poppins.className} text-xl md:text-2xl font-medium mb-1`}>{title}</h2>
...
const Feature = ({ icon, title, subtitle }: FeatureProps) => (
  <div className="flex items-center gap-4">
    <div className="text-[#029FAE] w-14 h-14">
      {icon}
    </div>
    <div>
      ...
      <p className={`${poppins.className} text-gray-500 text-base md:text-lg`}>
        {subtitle}
      </p>
    </div>
  </div>
...
const InputField = ({ 
  ...
  <div className="mb-8">
    <label className={`${poppins.className} text-base md:text-lg font-medium block mb-5`}>
      {label}
    </label>
    {type === "textarea" ? (
      <textarea
  ...
  return (
    <div className="max-w-screen-xl mx-auto mt-12 px-4 sm:px-6">
      <div className="text-center">
        <h1 className={`${poppins.className} text-4xl font-semibold sm:text-3xl`}>
